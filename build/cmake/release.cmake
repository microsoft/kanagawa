...
function(normalize_system_processor_name_for_release INPUT_VALUE DEFAULT_VALUE OUT_VAR)
  set(_value "${INPUT_VALUE}")
  if(_value STREQUAL "")
    set(_value "${DEFAULT_VALUE}")
  endif()
  ...
  string(REGEX REPLACE "^-+" "" _value "${_value}")
  string(REGEX REPLACE "-+$" "" _value "${_value}")
  if (_value STREQUAL "x86-64" OR _value STREQUAL "amd64")
    set(_value "x86_64")
  endif()
  if(_value STREQUAL "")
    set(_value "${DEFAULT_VALUE}")
...
normalize_system_processor_name_for_release("${CMAKE_SYSTEM_PROCESSOR}" "unknown-arch" _release_arch)
